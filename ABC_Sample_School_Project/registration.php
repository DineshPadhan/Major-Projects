...
<form method="post" enctype="multipart/form-data">
	...
	<p><b>UserName<span style="color:red">* </span>: </b><input type="text" name="uname" required/></p>
    <p><b>Password<span style="color:red">* </span>: </b><input type="password" name="upass" required/></p>
    <p><b>Email<span style="color:red">* </span>: </b><input type="email" name="umail" required/></p>
    <p><b>Gender : </b><input type="radio" name="gender" value="m">Male&nbsp;<input type="radio" name="gender" value="f">Female</p>
    <p><b>Mobile No.<span style="color:red">* </span>: </b><input type="text" name="umob" required/></p>
    <b>Address : </b><textarea placeholder="Input Address" name="address"></textarea><br><br><br>
<div style="background-color: #D8D8D8; display: flex; margin: 0 auto; width: max-content;"><span><strong>Verification</strong><span style="color:red">* </span><b>:&nbsp;</b></span><p><?php
error_reporting(1);
echo $res." = ";
?>
<input type="hidden" name="c1" value="<?php echo $sum; ?>">
<input type="text" name="c2" autofocus placeholder="Enter Sum"></p></div><br>
    <p><input type="submit" name="submit" value="Register" class="btn btn-primary" style="font-weight: 600;">&nbsp;&nbsp;<input type="reset" onClick="refresh()" class="btn btn-primary" style="font-weight: 600;"></p>
</form>
</div>
<!-- </body>
</html> -->